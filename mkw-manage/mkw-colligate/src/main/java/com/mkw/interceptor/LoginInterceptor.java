...
public class LoginInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		String sessionId = (String) request.getSession().getAttribute(KeyConstant.colligate.SESSION_ID);
		String accountId = (String) request.getSession().getAttribute(KeyConstant.colligate.SESSION_ACCOUNT_ID);
