...
<script type="text/javascript" src="${basePath }/static/module/roomGroup/roomGroup-list.js?r=${random }"></script>
<!-- 定义模板 -->
<script type="text/html" id="tablePage">
	<a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
	<a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="delete">删除</a>
	<a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="addFood">添加菜品</a>
</script>
</head>
<body>
