					...
					<ul class="layui-nav admin-header-item">
						<li class="layui-nav-item">
							<a href="javascript:;" class="admin-header-user">
								<span id="myName">&ensp; ${account.name }</span>
							</a>
			...
			<div class="layui-body" style="bottom: 0;border-left: solid 2px #1AA094;top: 40px;" id="admin-body">
				<div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
					<ul class="layui-tab-title">
						<li lay-id="1536374680506" class="layui-this">
							<i class="fa fa-dashboard" aria-hidden="true"></i>
							<cite id="firstCite"></cite>
						</li>
					</ul>
					<div class="layui-tab-content" style="min-height: 150px; padding: 5px 0 0 0;">
						<div class="layui-tab-item layui-show">
							<iframe id="firstIframe" src="/mkw-colligate/main.do"></iframe>
						</div>
					</div>
				</div>
			</div>
