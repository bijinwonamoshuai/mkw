...
<script type="text/javascript" src="${basePath }/static/module/roomFood/roomFood-edit.js?r=${random }"></script>
</head>
<body>
	<span id="roomFoodInfo" style="display: none">${roomFoodInfo }</span>
