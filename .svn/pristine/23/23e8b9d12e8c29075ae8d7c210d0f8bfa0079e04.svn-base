...
<script type="text/javascript" src="${basePath }/static/module/roomGroup/roomGroup-edit.js?r=${random }"></script>
</head>
<body>
	<span id="roomGroupInfo" style="display: none">${roomGroupInfo }</span>
